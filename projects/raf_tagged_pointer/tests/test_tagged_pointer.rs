...
use raf_tagged_pointer::{Bit, TaggedPointerNewError, TaggedPointer};
...
fn test_misalignement() {
    ...
    assert!(matches!(TaggedPointer::<i32, 16>::new(raw_ptr), Err(TaggedPointerNewError::PointerMisaligned)));
}
